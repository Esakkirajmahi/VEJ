...
<body style="overflow: visible;">
    ...
    <main>
        ...
        <div class="apply-process-area apply-bg pt-150 pb-150" data-background="assets/img/gallery/how-applybg.png" style="background-image: url(&quot;assets/img/gallery/how-applybg.png&quot;);">
            <div class="container">
                <!-- Section Tittle -->
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-10">
                        ...
                        <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 4270px; transform: translate3d(-1220px, 0px, 0px);"><div class="single-testimonial text-center slick-slide slick-cloned" tabindex="-1" role="tabpanel" aria-describedby="slick-slide-control02" style="width: 610px;" data-slick-index="-1" aria-hidden="true">
                                <!-- Testimonial Content -->
                            ...
                            </div><div class="single-testimonial text-center slick-slide" tabindex="-1" role="tabpanel" id="slick-slide00" aria-describedby="slick-slide-control00" style="width: 610px;" data-slick-index="0" aria-hidden="true">
                                <!-- Testimonial Content -->
                                <div class="testimonial-caption ">
                                    <!-- founder -->
                                    <div class="testimonial-founder  ">
                            ...
                            </div><div class="single-testimonial text-center slick-slide slick-current slick-active" tabindex="0" role="tabpanel" id="slick-slide01" aria-describedby="slick-slide-control01" style="width: 610px;" data-slick-index="1" aria-hidden="false">
                                <!-- Testimonial Content -->
                                <div class="testimonial-caption ">
                                    <!-- founder -->
                                    <div class="testimonial-founder  ">
                            ...
                            </div><div class="single-testimonial text-center slick-slide" tabindex="-1" role="tabpanel" id="slick-slide02" aria-describedby="slick-slide-control02" style="width: 610px;" data-slick-index="2" aria-hidden="true">
                                <!-- Testimonial Content -->
                                <div class="testimonial-caption ">
                                    <!-- founder -->
                                    <div class="testimonial-founder  ">
                            ...
                            </div><div class="single-testimonial text-center slick-slide slick-cloned" tabindex="-1" role="tabpanel" aria-describedby="slick-slide-control00" style="width: 610px;" data-slick-index="3" aria-hidden="true">
                                <!-- Testimonial Content -->
                                <div class="testimonial-caption ">
                                    <!-- founder -->
                                    <div class="testimonial-founder  ">
                            ...
                            </div><div class="single-testimonial text-center slick-slide slick-cloned" tabindex="-1" role="tabpanel" aria-describedby="slick-slide-control01" style="width: 610px;" data-slick-index="4" aria-hidden="true">
                                <!-- Testimonial Content -->
                                <div class="testimonial-caption ">
                                    <!-- founder -->
                                    <div class="testimonial-founder  ">
                            ...
                            </div><div class="single-testimonial text-center slick-slide slick-cloned" tabindex="-1" role="tabpanel" aria-describedby="slick-slide-control02" style="width: 610px;" data-slick-index="5" aria-hidden="true">
                                <!-- Testimonial Content -->
                                <div class="testimonial-caption ">
                                    <!-- founder -->
                                    <div class="testimonial-founder  ">
                            ...
                            </div></div></div><ul class="slick-dots" style="display: block;" role="tablist"><li class="" role="presentation"><button type="button" role="tab" id="slick-slide-control00" aria-controls="slick-slide00" aria-label="1 of 3" tabindex="-1">1</button></li><li class="slick-active" role="presentation"><button type="button" role="tab" id="slick-slide-control01" aria-controls="slick-slide01" aria-label="2 of 3" tabindex="0" aria-selected="true">2</button></li><li role="presentation" class=""><button type="button" role="tab" id="slick-slide-control02" aria-controls="slick-slide02" aria-label="3 of 3" tabindex="-1">3</button></li></ul></div>
                    </div>
                </div>
            </div>
        </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<!-- JS here -->
        ...
        <script src="./assets/js/main.js"></script><a id="scrollUp" href="#top" style="display: none; position: fixed; z-index: 2147483647;"><i class="ti-arrow-up"></i></a>
